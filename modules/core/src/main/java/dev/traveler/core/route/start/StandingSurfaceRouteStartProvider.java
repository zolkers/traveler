...
public final class StandingSurfaceRouteStartProvider implements SurfaceRouteStartProvider {
    @Override
    public List<SurfaceNode> startNodes(SurfaceRouteStartContext context) {
        ...
        return safeContext.surfaceNodes().standingSurfaces(safeContext.feetPosition());
    }
}
