...
public final class DefaultActionSteeringPolicy implements ActionSteeringPolicy {
    ...
    private static SteeringPlan jumpSteering(
        ...
        NavigationPoint start = path.nodeAt(Math.clamp(nextNodeIndex - 1, 0, path.nodeCount() - 2));
    ...
    private static double horizontalLength(NavigationPoint from, NavigationPoint to) {
